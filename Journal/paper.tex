...
At the feature level, Discover helps users quickly find what to cook from overwhelming content using personalized recommendations. Larder also provides recipe management, user accounts, Meal Plan, and Grocery, so users can move from discovering a dish to scheduling it and generating a shopping list within one app. Recipes can be imported from external sources such as URLs, images, or videos for unified management.
