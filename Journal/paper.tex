...
To support execution, we provide step-by-step guidance that can be used without touching the screen. The guidance view offers clear instructions, timers, and non-contact controls such as voice and gesture, so users can advance or repeat steps even with wet or greasy hands.
